...
/* ========= Section ========= */
const DiscoverStoriesSection: React.FC = () => {
  return (
    <section className="relative w-full bg-[#111827] py-24">
      <div className="max-w-7xl mx-auto px-6 mb-14 text-center">
        <h2 className="text-3xl font-bold text-white mb-4">
          Discover Worlds. Uncover Legends.
        </h2>
        <p className="max-w-xl mx-auto text-slate-400 text-sm">
          Step into a universe shaped by imagination — explore stories,
          characters and realms forged by creators across the Originverse.
        </p>
      </div>
...
export default DiscoverStoriesSection;
