...
const projects = [
  {
    ...
    description:
      "An epic 12-chapter comic series about the final dragon ruler.",
  ...
  },
  {
    ...
    description:
      "A cyberpunk thriller set in the year 1948 eroding the old spark.",
    image: "last_boy.png",
    progress: 90,
  ...
  },
  {
    ...
    description:
      "Young mages discover the darkest secret within their school walls.",
